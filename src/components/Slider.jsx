...
function Slider() {
  ...
  return (
    <div>
      <HiChevronLeft
        className="hidden text-white text-[30px] md:block absolute mx-8 mt-[200px] cursor-pointer"
        onClick={() => sliderLeft(elementRef.current)}
      />
      <HiChevronRight
        className="hidden text-white text-[30px] md:block absolute mx-8 mt-[200px] cursor-pointer right-0"
